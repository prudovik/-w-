/* Есть класс, описывающий телефон и включающий поля номер телефона, ФИО
владельца, дата постановки на учет и оператор. Необходимо сформировать
запросы по выборке сведений о телефоне по заданному ФИО и заданному
номеру телефона, а также вывести данные по всем телефонам,
сгрупированные по году, и данные по телефонам, сгрупированные
по оператору связи.*/
        ...
        while (choice != 6) {
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    var searchYear = phones.GroupBy(p => p.Year);
